...
![Publications per week from PubMed search for Mendelian randomi[s/z]ation, title only. Credits [@MR_lit](https://twitter.com/Mendelian_lit)](https://github.com/remlapmot/PubmedPlot/blob/gh-pages/articles/mr_files/figure-html/mr_fig-1.svg?raw=true)
