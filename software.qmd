...
For Ubuntu Linux Jammy Jellyfish users running R 4.3 through RStudio Desktop or RStudio Server, to install **TwoSampleMR** run the following code.
...
The equivalent code for Jammy Jellyfish users running R 4.3 is as follows.
