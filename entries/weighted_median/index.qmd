...
data:
  id: 7.0
  start_time: 1.7061674e+09
  completion_time: 1.7061712e+09
  email: anonymous
  name: .na
  ...
  method_name: MR Weighted Median
  abbreviated_method_name: Weighted Median
  publication_doi: https://doi.org/10.1002/gepi.21965
  code_repository_url: https://github.com/mrcieu/twosamplemr
  code_language: R
  method_website: https://mrcieu.github.io/TwoSampleMR/
  other_url: https://cran.r-project.org/web/packages/MendelianRandomization/index.html
  ...
  brief_description: A novel weighted median estimator for combining data on multiple
    genetic variants into a single causal estimate. This estimator is consistent even
    when up to 50% of the information comes from invalid instrumental variables. In
    a simulation analysis, it is shown to have better finite-sample Type 1 error rates
    than the inverse-variance weighted method, and is complementary to the recently
    proposed MR-Egger (Mendelian randomization-Egger) regression method.
  title: Weighted Median
  author: Gibran Hemani
