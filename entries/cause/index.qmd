...
data:
  id: 2.0
  start_time: 1.7060346e+09
  completion_time: 1.7060348e+09
  email: anonymous
  name: .na
  last_modified_time: .na
  primary_entry_contact: Jean Morrison
  primary_entry_contact_email_address: jvmorr@umich.edu
  primary_method_contact: Jean Morrson
  primary_method_contact_email_address: jvmorr@umich.edu
  ...
  code_language: R
  method_website: https://jean997.github.io/cause/
  other_url: none
  ...
  which_mr_conditions__assumptions_are_requiredrelaxed_by_the_method: The method is
    ...
    the InSIDE assumption.;The method accounts for partial or full overlap between
    exposure and outcome samples.;
  brief_description: A Bayesian MR method accounting for correlated and uncorrelated
