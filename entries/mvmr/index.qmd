...
data:
  id: 13.0
  start_time: 1.7061862e+09
  completion_time: 1.7061865e+09
  email: anonymous
  name: .na
  ...
  method_name: Multivariable MR
  abbreviated_method_name: MVMR
  publication_doi: https://doi.org/10.1093/ije/dyy262
  ...
  what_data_types_can_the_method_be_used_with: Individual level data for both exposure(s)
    and outcome(s) (or all traits if Network MR);GWAS summary statistics for both
    exposure(s) and outcome(s) (or all traits if Network MR);
  which_mr_conditions__assumptions_are_requiredrelaxed_by_the_method: The method accounts
    ...
    assumption.;
  brief_description: This method estimates causal effects in multivariable MR models,
    including sensitivity tests for heterogeneity and weak instruments
  title: MVMR
  author: Eleanor Sanderson
  slug: mvmr
  pubdate: '2018-12-10'
