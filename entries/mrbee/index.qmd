...
data:
  ...
  which_analysis_types_is_the_method_used_for: Univariable MR (one exposure, one outcome);Multivariable
    MR (multiple exposures, one outcome);
  ...
  which_mr_conditions__assumptions_are_requiredrelaxed_by_the_method: The method is
    ...
    (InSIDE) assumption. ;
  brief_description: We introduce MRBEE (MR using Bias-corrected Estimating Equation),
    a novel multivariable MR method capable of simultaneously removing error-in-variable
    bias and identifying horizontal pleiotropy.
  title: MRBEE
  author: Jean Morrison
  slug: mrbee
  pubdate: '2023.01'
